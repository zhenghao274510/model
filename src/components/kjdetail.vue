        ...
        <ul>
          <li v-for="(item,index) in dataList" :key="index">
            ...
            <div class="bottom">
              ...
              <div class="option" v-if="item.secondcount!=0">
...
.ut li{width: 25%;text-align: center;height: 45px;line-height: 45px;font-size: 13px;border-right: 1px solid #EEEEEE;}
.ut li:last-child{border: none}
.con,.con2{
  padding: 0 12px 10px;
}
.liuptitle{
